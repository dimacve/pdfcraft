...
export const locales = ['en', 'ja', 'ko', 'es', 'fr', 'de', 'zh', 'zh-TW', 'pt', 'ar', 'it', 'id', 'vi', 'lv'] as const;
...
export const localeConfig: Record<Locale, {
  ...
  lv: { name: 'Latvian', nativeName: 'Latviešu', direction: 'ltr', dateFormat: 'DD.MM.YYYY' },
};
...
export function getLocalizedPath(path: string, locale: Locale): string {
  ...
  const cleanPath = path.replace(/^\/(en|ja|ko|es|fr|de|zh-TW|zh|pt|ar|it|id|vi|lv)(\/|$)/, '/');
